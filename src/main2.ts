...
import DiceGrid, { DiceCrystal } from "./DiceRenderer2";

const diceCanvas = document.getElementById("dice-canvas") as HTMLCanvasElement
const diceGrid = document.querySelector("div.dice-grid") as HTMLElement
const diceDivs = document.querySelectorAll("div.dice")
